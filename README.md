...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyzotero-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6593&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyzotero-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyzotero` can be installed with:

```
conda install pyzotero
```

It is possible to list all of the versions of `pyzotero` available on your platform with:
